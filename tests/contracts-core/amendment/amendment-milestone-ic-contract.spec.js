...
import { fillScopeOfWork, fillSpecialClause } from '../../../helpers/contracts-core/ic-contract-creation-flow-ui/ic-base-methods';
...
test.describe('Amendment Milestone contract', () => {
  ...
  test(
    'Client should amend Milestone contract successfully @contract-core-qa-front',
    {
      tag: ['@slowRegression'],
    },
    async ({ page, request }) => {
  ...
  test(
    'Client should delete attachment successfully during amendment Milestone IC @contract-core-qa-front',
    {
      tag: ['@slowRegression'],
    },
    async ({ page, request }) => {
  ...
  test(
    'Client should create draft amendment successfully for Milestone @contract-core-qa-front',
    {
      tag: ['@slowRegression'],
    },
    async ({ page, request }) => {
  ...
  test('Client should delete draft amendment successfully for Milestone @contract-core-qa-front', async ({ page, request }) => {
    // Create the contract and sign from both sides
    const contractData = {
      client,
      contractor,
  ...
  test(
    'Contractor should sign Milestone amendment from Home page task @contract-core-qa-front',
    {
      tag: ['@slowRegression'],
    },
    async ({ page, request }) => {
