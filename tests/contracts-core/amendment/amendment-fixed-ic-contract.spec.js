...
test.describe('Amendment Fixed contract', () => {
  ...
  test(
    'Client should amend Fixed contract successfully @contract-core-qa-front',
    {
      tag: ['@slowRegression'],
    },
    async ({ page, request }) => {
      ...
      await page.getByRole('button', { name: icContractAmendmentSelectors.continueToEditButton }).click();
  ...
  test(
    'Client should delete attachment successfully during amendment Fixed IC @contract-core-qa-front',
    {
      tag: ['@slowRegression'],
    },
    async ({ page, request }) => {
  ...
  test(
    'Client should create draft amendment successfully for Fixed @contract-core-qa-front',
    {
      tag: ['@slowRegression'],
    },
    async ({ page, request }) => {
  ...
  test('Client should delete draft amendment successfully for Fixed @contract-core-qa-front', async ({ page, request }) => {
    // Create the contract and sign from both sides
    const contractData = {
      client,
      contractor,
  ...
  test(
    'Contractor should sign Fixed amendment from Home page task @contract-core-qa-front',
    {
      tag: ['@slowRegression'],
    },
    async ({ page, request }) => {
